...
export default {
  ...
  beforeCreate() {
    ...
    axios
      .get(
        "https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/chart.tracks.get?chart_name=hot&page=1&page_size=10&f_has_lyrics=1&apikey=83b9c178f2228a8c4ea844a1e662c119"
      )
